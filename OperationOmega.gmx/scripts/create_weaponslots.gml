switch(global.shipselect)
{
    //Alphastar
    case 1:
        obj_customizer.weaponslot[1] = instance_create(207, 18, obj_choosesecondary);
        ...
        {
            obj_customizer.weaponslot[2] = instance_create(247, 18, obj_choosesecondary);
            ...
            obj_customizer.weaponslot[3] = instance_create(287, 18, obj_choosesecondary);
            ...
            obj_customizer.weaponslot[4] = instance_create(327, 18, obj_choosesecondary);
