...
obj_chooseprimary.y = 38;
switch(global.shipselect)
{
    //Alphastar
    case 1:
        obj_customizer.weaponslot[1] = instance_create(268, 38, obj_choosesecondary);
        ...
        {
            obj_customizer.weaponslot[2] = instance_create(308, 38, obj_choosesecondary);
            ...
            obj_customizer.weaponslot[3] = instance_create(348, 38, obj_choosesecondary);
            ...
            obj_customizer.weaponslot[4] = instance_create(388, 38, obj_choosesecondary);
