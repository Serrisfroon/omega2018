...
do
{
    ...
    vnumber = returndata[0, 0];
    numberoffiles = real(returndata[1, 0]);
    donefiles = 0;
...
until(vnumber = newversion);

//Download the latest .exe
download_file("http://www.insomniasoft.net/version/Operation%20Omega.exe", "Operation Omega.exe");

show_message("Operation Omega has finished updating. The game will now restart.");
